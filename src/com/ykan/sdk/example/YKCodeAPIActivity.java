                ...
                switch (viewId) {
                    case R.id.getDeviceType:
                        DeviceTypeResult deviceResult = ykanInterface
                                .getDeviceType(currGizWifiDevice.getMacAddress());
                    ...
                    case R.id.getBrandByType:
                        ...
                        if (currDeviceType != null) {
                            BrandResult brandResult = ykanInterface
                                    .getBrandsByType(currGizWifiDevice.getMacAddress(), currDeviceType.getTid());
                    ...
                    case R.id.getMatchedDataByBrand:
                        if (currBrand != null) {
                            controlResult = ykanInterface.getRemoteMatched(currGizWifiDevice.getMacAddress(),
                    ...
                    case R.id.getDetailByRCID:
                        if (!Utility.isEmpty(currRemoteControl)) {
                            remoteControl = ykanInterface
                                    .getRemoteDetails(currGizWifiDevice.getMacAddress(), currRemoteControl.getRid());
